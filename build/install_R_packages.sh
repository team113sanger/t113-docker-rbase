...
Rscript -e "install.packages( pkgs = c( 'devtools', 'tidyverse', 'argparse', 'optparse', 'pheatmap', 'viridis', 'extrafont', 'rdgal', 'ggrepel', 'showtext', 'GGally', 'jsonlite', 'RColorBrewer', 'futile.logger' ), repos = 'https://www.stats.bris.ac.uk/R/', dependencies = TRUE, clean = TRUE )"
